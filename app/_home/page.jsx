    ...
    const services = [
        {
            ...
            description: "Cutting-edge decentralized applications and blockchain solutions",
        ...
        },
        {
            ...
            description: "Data-driven strategies for exponential business growth",
    ...
    return (
        <div className={`min-h-screen transition-colors duration-500 ${darkMode ? 'bg-black text-white' : 'bg-gradient-to-br from-gray-50 via-white to-gray-100 text-gray-900'}`}>
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
                <div
                    className={`absolute w-[600px] h-[600px] rounded-full blur-[120px] animate-float ${darkMode ? 'opacity-20' : 'opacity-10'}`}
                    style={{
                ...
                />
                <div
                    className={`absolute w-[500px] h-[500px] rounded-full blur-[100px] animate-float-delayed ${darkMode ? 'opacity-20' : 'opacity-10'}`}
                    style={{
                ...
                />
                <div
                    className={`absolute w-[550px] h-[550px] rounded-full blur-[110px] animate-float-slow ${darkMode ? 'opacity-15' : 'opacity-8'}`}
                    style={{
                    ...
                    <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                        ...
                        <div className="space-y-6">
                            ...
                            <button
                                ...
                                className="group relative w-full px-8 py-5 font-bold text-lg overflow-hidden rounded-2xl"
                            >
                                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 opacity-100 group-hover:opacity-90 transition-opacity" />
                                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 blur-xl opacity-50 group-hover:opacity-75 transition-opacity" />
